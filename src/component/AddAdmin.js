...
const AddAdmin = () => {
    ...
    const handleMySubmit = async (e) => {
        e.preventDefault()
        let response = await addAdmin(name,surname,mobile,email,username,password)
  ...
  return (
    <div>
      <form>
            ...
            <button type="submit" className="btn btn-primary" onClick={handleMySubmit}>Add Admin</button>
        </form>
        <br/>
    </div>
  )
